      ...
      <div id="PagePresentation">
        ...
        <div id="FirstBox">
          ...
          <div className="gs_reveal">
            ...
            <br></br>
            <br></br>
            <p className="gs_reveal">L'équipe Univok, 38 étudiants de Junia, a gagné les campagnes en mai 2022 et est devenus la nouvelle AS JUNIA.</p>
            <br></br>
            <br></br>
        ...
        <div className="infoMembre gs_reveal">
          Nous sommes une équipe de 38 étudiants de Junia de différentes promotions. <br></br>Pour mieux nous organiser, nous nous sommes répartis dans plusieurs pôles, en fonction de ce qui correspond le mieux à chacun.
